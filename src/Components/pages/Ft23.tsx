...
const Ft23 = () => {
  ...
  return (
    <div className="main">
      ...
      <div className="content-box">
        <div className="image-container">
          <img src={flunkyball_3} alt="Image" />
        </div>
        <div className="text-container">
